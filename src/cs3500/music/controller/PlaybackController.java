 ...
 * it to the user.
 */
public final class PlaybackController implements Controller {
  /**
   ...
   */
  public PlaybackController(MusicEditorModel model) {
   ...
   */
  public PlaybackController(MusicEditorModel model0, InputStream in, Appendable out) {
